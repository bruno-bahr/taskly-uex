        ...
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center gap-10">
                <a href="{{ route('dashboard') }}" wire:navigate>
                    <span class="font-serif text-xl font-medium text-ink">Taskly</span>
                </a>
            ...
            <div class="hidden sm:flex sm:items-center">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center gap-2 text-sm text-ink/70 hover:text-ink transition">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-ink/50 hover:text-ink hover:bg-paper focus:outline-none transition">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-line">
        ...
        <div class="pt-4 pb-3 border-t border-line">
            <div class="px-4">
                ...
                <div class="text-sm text-ink/60">{{ auth()->user()->email }}</div>
            </div>
